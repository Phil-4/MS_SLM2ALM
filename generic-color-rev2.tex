...
In a routine clinical application, more than some 7 to 9 points per level map will probably be undesirable, because with a typical amount of 6–8 test frequencies, extrapolation of the figures given in Sec. II.D would lead to a measurement time of 3min35' to 6min8' in the current implementation.
